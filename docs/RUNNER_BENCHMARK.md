...
| RQ-709-FINAL | #709 / PR #710 | P15 Fast Batch Button hover interaction styling v1 | Required PR exact-head gate set | 3 capabilities: bounded box shadow + transition seconds + core hover animation; one final bound-head CI cycle | `FINAL_BATCH` | final bound PR head must pass all seven required gates before merge | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
