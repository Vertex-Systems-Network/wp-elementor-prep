...
| RQ-703-FINAL | #703 / PR #704 | P15 Button hover text color v1 | Required PR exact-head gate set | exact Elementor 4.2.4 source-bound write surface: `hover_color`; normal/background/hover-background expansion false | `FINAL_BATCH` | final bound PR head must pass CI/CodeQL/Integration/P12 Offline/P12 Final/P15 target/P17 browser before merge | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
