...
| RQ-677-FINAL | #677 | P15 bounded Text Editor normal text color | Required PR exact-head gate set | branch implementation + focused security tests; PR not opened yet | `FINAL_BATCH` | exact PR head must pass CI/CodeQL/Integration/P12 Offline/P12 Final/P15 target/P17 browser before merge | IMPLEMENTING_PR_NOT_OPEN |
