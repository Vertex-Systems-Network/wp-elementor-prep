...
| RQ-697-FINAL | #697 / PR #698 | Post-PR #696 AI-native reconciliation | Required PR exact-head gate set | PR opened against base main `8c6895ec...`; lifecycle binding advances final head; governance/status-only synchronization; no product/runtime change | `FINAL_BATCH` | final bound PR head must pass CI/CodeQL/Integration/P12 Offline/P12 Final/P15 target/P17 browser before merge | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
