...
| RQ-651-FINAL | #651 / PR #652 | P14 R3 vertical-stack candidate target-addressing contract | Required PR exact-head gate set | focused PR open; creation head `1c92125c4933a8bb1e208863de79e7e5ae419323`; post-binding exact head pending capture; runtime/production registry remain closed | `FINAL_BATCH` | focused tests plus exact-head required repository checks PASS before merge | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
