...
| RQ-653-FINAL | #653 / PR #654 | P14 R4 vertical-stack retained-duplicate Figma runtime adapter | Required PR exact-head gate set | prior exact head `0647342257919a99c3d7a0276ef29366b4a805ac` failed CI/P12 Final on the same TS7022 candidate-path child inference issue; repair commit `e20e9f98787c128527df6488bee7918f1f9cb667` adds explicit `SceneNode | undefined` typing without weakening runtime/security/authority checks | `FINAL_BATCH` | repaired exact-head fake-Figma tests plus required repository checks PASS before merge | REPAIRED_AWAITING_NEW_EXACT_HEAD_BATCH |
