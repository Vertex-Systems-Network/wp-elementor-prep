...
| RQ-645-FINAL | #645 / PR #646 | Post-PR #644 durable-state reconciliation | Required PR exact-head gate set | compact state/claims/queue/Runner ledgers bound to merged main `c5d23152a704fb75c18970cb147a8f6ee4775ebd`; no product/runtime authority changes | `FINAL_BATCH` | exact-head governance tests and required repository checks PASS | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
