...
| RQ-643-FINAL | #643 / PR #644 | Post-P14 R1 durable-state reconciliation | Required PR exact-head gate set | compact state/claims/queue/Runner ledgers bound to merged main `f428114dd2276ebf2033f88e393872281d03b608`; no product/runtime authority changes | `FINAL_BATCH` | exact-head governance tests and required repository checks PASS | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
