...
| RQ-671-FINAL | #671 | P15 bounded Container overflow hidden/auto | Required PR exact-head gate set | branch implementation + focused tests; PR not opened yet | `FINAL_BATCH` | exact PR head must pass CI/CodeQL/Integration/P12 Offline/P12 Final/P15 target/P17 browser before merge | IMPLEMENTING_PR_NOT_OPEN |
