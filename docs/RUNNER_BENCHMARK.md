...
| RQ-675-FINAL | #675 / PR #676 | P15 bounded Heading normal text color | Required PR exact-head gate set | creation head `c2ab7472...`; strict security contract retained; binding commits follow; no CI PASS claimed | `FINAL_BATCH` | final exact PR head must pass CI/CodeQL/Integration/P12 Offline/P12 Final/P15 target/P17 browser before merge | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
