...
| RQ-647-FINAL | #647 / PR #648 | Post-PR #646 durable-state reconciliation | Required PR exact-head gate set | compact state/claims/queue/Runner ledgers bound to merged main `f77ac93460bcb4625b76b914d81bd63fd9706982`; no product/runtime authority changes | `FINAL_BATCH` | exact-head governance tests and required repository checks PASS | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
