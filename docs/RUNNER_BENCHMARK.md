...
| RQ-711-FINAL | #711 / PR #712 | P15 Fast Batch Button normal border styling v1 | Required PR exact-head gate set | 3 capabilities: border type + desktop px width + border color; one final bound-head CI cycle | `FINAL_BATCH` | final bound PR head must pass all seven required gates before merge | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
