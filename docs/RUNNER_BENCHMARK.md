...
| RQ-707-FINAL | #707 / PR #708 | P15 Button hover border color v1 | Required PR exact-head gate set | exact Elementor 4.2.4 direct control write surface: `button_hover_border_color`; hover text/background/shadow/transition/animation and normal border expansion false | `FINAL_BATCH` | final bound PR head must pass CI/CodeQL/Integration/P12 Offline/P12 Final/P15 target/P17 browser before merge | PR_OPEN_AWAITING_EXACT_HEAD_BATCH |
