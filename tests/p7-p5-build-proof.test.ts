...
describe('P7 build-bound P5 runtime proof', () => {
  it('accepts only the exact core proof timestamp and exact traceable build', async () => {
    ...
    const proof = createP5RuntimeProof(BUILD_A, '2026-09-08T12:00:00.000Z');
  ...
  it('rejects a receipt when the core proof was regenerated later', () => {
    const oldProof = createP5RuntimeProof(BUILD_A, '2026-09-08T12:00:00.000Z');
    const newProof = createP5RuntimeProof(BUILD_A, '2026-09-08T12:05:00.000Z');
