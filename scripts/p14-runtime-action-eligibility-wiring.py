...
PROFILES = Path('tests/p14-validation-profile-coverage.test.ts')
...
POSITIVE_RECHECK = """  async assessActionEligibility(_candidate: P14CandidateHandle, action: P14PreparationAction): Promise<unknown> {\n    return {\n      actionId: action.actionId,\n      recipeId: action.recipeId,\n      checkedPrerequisiteRecipeIds: [...action.prerequisiteRecipeIds],\n      eligible: true,\n    };\n  }\n\n"""
...
replace_exact(
    ...
    """  async cloneSource(sourceNodeId: string): Promise<P14CandidateHandle> {\n    this.cloneCalls += 1;\n    return { sourceNodeId, candidateNodeId: 'candidate:1' };\n  }\n\n""" + POSITIVE_RECHECK + """  async applyRecipe(candidate: P14CandidateHandle, action: P14PreparationAction): Promise<P14RecipeExecutionResult> {\n""",
)

replace_exact(
    INTEGRITY,
    """  async cloneSource(sourceNodeId: string): Promise<P14CandidateHandle> {\n    this.calls.clone += 1;\n    return { sourceNodeId, candidateNodeId: 'candidate:1' };\n  }\n\n  async applyRecipe(_candidate: P14CandidateHandle, action: P14PreparationAction): Promise<P14RecipeExecutionResult> {\n""",
    """  async cloneSource(sourceNodeId: string): Promise<P14CandidateHandle> {\n    this.calls.clone += 1;\n    return { sourceNodeId, candidateNodeId: 'candidate:1' };\n  }\n\n""" + POSITIVE_RECHECK + """  async applyRecipe(_candidate: P14CandidateHandle, action: P14PreparationAction): Promise<P14RecipeExecutionResult> {\n""",
)
