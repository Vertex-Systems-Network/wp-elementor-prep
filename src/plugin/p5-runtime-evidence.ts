 ...
 * Acceptance is always recomputed from the captured result so callers cannot supply a contradictory
 * PASS. The bundle contains no PNG bytes, Figma nodes or mutation candidates.
 */
