...
| P14 Target-Ready Duplicate + Guided Prepare | CORE IMPLEMENTATION IN PROGRESS / RUNTIME UNWIRED | N/A | `──────────` | Complete #201 / PR #205 coordinator runtime-evidence/lease-cleanup hardening; production registry remains empty; #159 required before real Figma mutation exposure |
...
1. complete #201 / PR #205 coordinator runtime-evidence and lease-cleanup hardening while real Figma mutation remains unwired;
