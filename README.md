...
| P14 Target-Ready Duplicate + Guided Prepare | CORE + READ-ONLY RUNTIME PREVIEW IN PROGRESS / MUTATION UNWIRED | N/A | `──────────` | Complete #264 status sync; preview is exact-context/current-build bound; production registry remains empty; #159 required before real Figma mutation exposure |
