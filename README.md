...
- Responsive values serialize only to `color_stop_tablet/mobile` and `color_b_stop_tablet/mobile` under the requested normal or hover radial group prefix.
...
- Terminal #765 / PR #766 passed all seven required gates on exact head `944fc059beff227be6a70e386c047eb4df624325`, had 0 unresolved review threads and merged as main `c33287283e8ee383f2eda1d143778dac5142cf36`; it remained transport-only and non-canonical.
