...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #759 / PR #760 exact head `ef1687c1...` passed 7/7 with 0 unresolved threads and merged as main `105f7594...`; canonical state is idle-ready while transport-only Issue #761 finalizes durable state.
