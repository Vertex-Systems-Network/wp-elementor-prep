...
PR #546 / #545 completed the exact declared-profile registry, PR #548 / #547 completed exact retained-candidate binding, PR #552 / #551 added source-bound image-reference resolution, PR #554 / #553 added explicit Heading/Button semantic promotion, PR #556 / #555 added tablet/mobile direction, PR #558 / #557 linked-px gap, PR #560 / #559 flex align/justify, PR #562 / #561 px padding, PR #564 / #563 added one separate controlled URL-only Image → Elementor target-managed media rewrite observation, and PR #566 / #565 binds only its exact full-pass evidence into a sanitized observed asset-reference evidence artifact.
...
6. next asset/reference work must keep `OBSERVED_PROOF_VALIDATED` separate from an internal closure decision and target a separately specified internal-decision / durable target-managed portability gap with exact evidence; do not add more responsive controls as a blanket claim;
...
Do not broaden semantics, responsive behavior or asset portability through heuristics merely to increase coverage. #556/#558/#560/#562 are bounded responsive slices and #564 is one bounded URL-only → target-managed media rewrite observation and #566 is only its sanitized observed-evidence binding; an explicit internal closure decision plus durable target-managed portability evidence remain the primary concrete gap.
