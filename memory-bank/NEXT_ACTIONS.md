...
2. keep responsive decisions explicit and exact-source/candidate-bound: #556 writes only direction, #558 only linked-px gap, and #560 only verified flex align/justify default-breakpoint overrides; desktop values remain preserved and omitted responsive controls remain omitted;
...
5. next responsive work must be one separately bounded documented control gap (for example padding) rather than a blanket responsive claim;
...
Do not broaden semantics or responsive behavior through heuristics merely to increase coverage. #556/#558/#560 are explicit default-breakpoint direction + linked-px gap + flex alignment slices; broader responsive and real reference/asset closure remain concrete gaps.
