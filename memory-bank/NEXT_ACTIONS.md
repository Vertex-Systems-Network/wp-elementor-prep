...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #743 / PR #744 Button icon basics passed 7/7 on exact head `a17d0ca3...` and merged as main `4e5ea4eb...`; canonical state is idle-ready while transport-only terminal finalization #745 / PR #746 awaits exact-head certification.
