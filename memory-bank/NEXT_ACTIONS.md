...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #735 / PR #736 Button type/size/safe-id passed 7/7 on repaired exact head `80c63a72...` and merged as main `0593dd79...`; canonical state is idle-ready while transport-only terminal finalization #737 / PR #738 awaits exact-head certification.
