...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #731 / PR #732 Button responsive padding passed 7/7 on exact head `8ba3ec30...` and merged as main `d0404cfc...`; canonical state is idle-ready while transport-only terminal finalization #733 / PR #734 awaits exact-head certification.
