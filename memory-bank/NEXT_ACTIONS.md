...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #751 / PR #752 exact head `bea1e621...` passed 7/7 with 0 unresolved threads and merged as main `702177b3...`; canonical state is idle-ready while transport-only Issue #753 finalizes durable state.
