...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Terminal #765 / PR #766 passed 7/7 on exact head `944fc059...` and merged as main `c3328728...`. Issue #767 / PR #768 is the active Fast Batch for explicit normal/hover tablet/mobile radial-gradient stop pairs; final exact-head certification is pending.
