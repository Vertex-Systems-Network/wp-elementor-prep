...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. PR #670 / #669 is merged on `687bb210...`; #671 / PR #672 is the active exact-bound standalone Container overflow `hidden|auto` slice. #672 first exact head `0ea6ee2a...` passed 5/7; README table delimiter repair is applied and repaired-head re-verification is pending.
