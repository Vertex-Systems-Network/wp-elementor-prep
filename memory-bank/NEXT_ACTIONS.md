...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. PR #670 / #669 is merged on `687bb210...`; #671 is the active exact-bound standalone Container overflow `hidden|auto` slice.
