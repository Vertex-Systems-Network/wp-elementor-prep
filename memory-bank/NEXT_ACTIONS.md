...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Terminal #745 / PR #746 passed 7/7 on exact head `7c484349...` and merged as main `c4095311...`. Issue #747 / PR #748 is the active Fast Batch for exact normal + hover linear gradients and optional bounded angle; final exact-head certification is pending.
