...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #755 / PR #756 exact head `180e3391...` passed 7/7 with 0 unresolved threads and merged as main `43a2e224...`; canonical state is idle-ready while transport-only Issue #757 finalizes durable state.
