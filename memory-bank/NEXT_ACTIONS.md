...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #739 / PR #740 stretch/content-alignment passed 7/7 on exact head `0a4cc0d2...` and merged as main `5e839f4e...`; canonical state is idle-ready with transport-only terminal finalization #741 prepared.
