...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #763 / PR #764 exact head `82bc12cc...` passed 7/7 with 0 unresolved threads and merged as main `143ffcab...`; canonical state is idle-ready while transport-only Issue #765 finalizes durable state.
