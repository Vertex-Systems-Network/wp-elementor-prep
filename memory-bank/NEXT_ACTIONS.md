...
2. keep responsive decisions explicit and exact-source/candidate-bound: #556 writes only direction, #558 linked-px gap, #560 verified flex align/justify, #562 px padding and #576 `nowrap`/`wrap` default-breakpoint overrides; desktop values remain preserved and omitted responsive controls remain omitted;
