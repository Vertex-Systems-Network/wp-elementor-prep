...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #747 / PR #748 repaired exact head `b8da6da7...` passed 7/7 with 0 unresolved threads and merged as main `7659adaa...`; canonical state is idle-ready while transport-only Issue #749 finalizes durable state.
