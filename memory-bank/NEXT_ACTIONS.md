...
- P15 — **CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED**. Issue #767 / PR #768 exact head `db2dcdba...` passed 7/7 with 0 unresolved threads and merged as main `16a67afb...`; canonical state is idle-ready while transport-only Issue #769 finalizes durable state.
