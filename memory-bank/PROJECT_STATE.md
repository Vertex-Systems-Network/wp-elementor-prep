...
## P15 Fast Batch #713 Button visual depth and radius
...
Issue #713 / PR #714 is active. One exact-bound composite Button resolver provides three related capabilities: bounded normal text shadow, bounded normal box shadow and explicit desktop/tablet/mobile integer-px border radius. Padding, inference, compatibility, production and download authority remain false/out of scope.
## P16 state
