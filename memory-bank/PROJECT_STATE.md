...
## P15 #705 Button hover classic background color

PR #704 exact head `39ce33bff3a7914466b00c11932aaa8118f56336` passed all seven required gates and merged as main `a36219fb01e90780c1c962dc7b534dbbcda40bed`; Issue #703 closed completed. Its exact Button hover text write surface remains bounded to strict lowercase six-digit `hover_color`.

Issue #705 is the active bounded product owner on branch `p15/button-hover-classic-background-color`. PR #706 is open against exact main `a36219fb01e90780c1c962dc7b534dbbcda40bed`.

The #705 exact write surface is only `button_background_hover_background=classic` plus strict lowercase six-digit `button_background_hover_color`, bound to Elementor 4.2.4 Button trait, Background group and group-prefix evidence. Hover text, normal text/background, gradients/image/video, global/theme tokens, responsive inference, compatibility, production and download authority remain excluded.
## P16 state
