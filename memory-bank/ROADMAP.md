...
| P15 | Elementor native export + import validation | CORE FOUNDATION IN PROGRESS / CONTROLLED TARGET PROOF RETAINED | N/A | `──────────` | Exact proof/profile/candidate binding retained; #552 adds source-bound URL-only image resolution while real asset closure, broader semantics and responsive coverage remain pending |
